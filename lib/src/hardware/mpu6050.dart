...
class MPU6050 {
  ...
  double getAccelXAngle(double x, double y, double z) {
    // v1 - 360
  ...
  double getAccelYAngle(double x, double y, double z) {
    // v2
  ...
  void updateValues() {
    ...
    _accelAngleX = getAccelXAngle(
        _accelAccelerationX, _accelAccelerationY, _accelAccelerationZ);
    _accelAngleY = getAccelYAngle(
        _accelAccelerationX, _accelAccelerationY, _accelAccelerationZ);
    _accelAngleZ = getAccelZAngle();

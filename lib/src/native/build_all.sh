...
gcc -I/usr/local/include/periphery/  -Wall -fPIC -O3 -shared gpio.c serial.c i2c.c led.c pwm.c libperiphery_${BITNESS}.a  -lpthread -o dart_periphery_static_${BITNESS}.1.0.0.so
